...
import com.example.cryptocurrency.presentation.coin_detail.components.CoinTage
        ...
        state.coin?.let { coin ->
            LazyColumn(
                ...
                item {
                    ...
                    Spacer(modifier = Modifier.height(15.dp))
                    Text(text = "Team Members", style = MaterialTheme.typography.bodyMedium)
                    Spacer(modifier = Modifier.height(15.dp))
